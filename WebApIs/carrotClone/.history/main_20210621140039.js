...
class CarrotAndBug {
  ...
  createCarrot(){
    ...
    newCarrot.style.left = Math.random()* 650 + 'px';
    newCarrot.style.right = Math.random()* 650 + 'px';
  ...
  createBug(){
    ...
    newBug.style.left = Math.random()* 650 + 'px';
    newBug.style.right = Math.random()* 650 + 'px';
