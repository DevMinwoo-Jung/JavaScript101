...
class CarrotAndBug {
  ...
  createCarrot(){
    ...
    newCarrot.style.left = Math.random()* 700 + 'px';
    newCarrot.style.right = Math.random()* 700 + 'px';
  ...
  createBug(){
    ...
    newBug.style.left = Math.random()* 700 + 'px';
    newBug.style.right = Math.random()* 700 + 'px';
