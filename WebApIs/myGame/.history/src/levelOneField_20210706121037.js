...
export class LvOneField{
  ...
  _addFishes(className, count, imgPath){
    ...
    const fishDivW = this.fishDiv.offsetWidth - FISH_DIV_SIZE;
    const fishDivH = this.fishDiv.offsetHeight - FISH_DIV_SIZE;
  ...
  animateFish() {
    for(let wrong of document.querySelectorAll('.wrong')){
      let currX = this.fishDiv.offsetWidth - FISH_SIZE;
      let currY = this.fishDiv.offsetHeight - FISH_SIZE;
